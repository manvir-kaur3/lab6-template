...
class Student:
    ...
    def __init__(self, name, number):
        self.name = name
        self.number = str(number)  # Convert to string to avoid type errors
        self.courses = {}
    ...
    def displayGPA(self):
        ...
        gpa = sum(self.courses.values())  # Sum grades
...
if __name__ == '__main__':
    ...
    student2 = Student('Jessica', 123456)  # Integer as student number
